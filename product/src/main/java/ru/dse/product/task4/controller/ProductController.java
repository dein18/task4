package ru.dse.product.task4.controller;

import lombok.RequiredArgsConstructor;
import org.springframework.web.bind.annotation.*;
import ru.dse.product.task4.dto.ProductDto;
import ru.dse.product.task4.service.ProductService;

import java.util.List;

import static ru.dse.product.task4.util.Constance.API_PRODUCTS;
